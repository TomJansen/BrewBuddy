...
type
  ...
  TfrmMain = class(TForm)
    ...
    lSGAfter: TLabel;
    lVolumeAfter: TLabel;
    lVolumeAfterUnit: TLabel;
    lSG4: TLabel;
    lSGTemp: TLabel;
    lSGCorr: TLabel;
    lCalories: TLabel;
    lAmCellsNeeded: TLabel;
    ...
    lSGendmash: TLabel;
    lBoilTime: TLabel;
    lEfficiencyMash: TLabel;
    lBeginSG: TLabel;
    lABV2: TLabel;
    lAfterBoilUnit1: TLabel;
    lAfterBoilUnit2: TLabel;
    ...
    seTunTemp: TSpinEdit;
    lTunTemp: TLabel;
    lGrainTempUnit: TLabel;
    lTunTempUnit: TLabel;
    lInfuseAmount: TLabel;
    fseInfuseAmount: TFloatSpinEdit;
    lInfuseAmountUnit: TLabel;
    cbTunTemp: TCheckBox;
    bbWaterAdjustment: TBitBtn;
    gbWater: TGroupBox;
    lMashWater: TLabel;
    lMashWaterUnit: TLabel;
    lSpargeWater: TLabel;
    lSpargeWaterUnit: TLabel;
    lSpMa: TLabel;
    lGrainAbsorption: TLabel;
    lGrainAbsorptionUnit: TLabel;
    lSpargeDeadSpace: TLabel;
    fseSpargeDeadspace: TFloatSpinEdit;
    lSpargeDeadSpaceUnit: TLabel;
    lBoilSize: TLabel;
    lBoilSizeUnit: TLabel;
    lEvap: TLabel;
    lEvapUnit: TLabel;
    lAfterBoil: TLabel;
    lAfterBoilUnit: TLabel;
    lChillerLoss: TLabel;
    lAfterBoil2: TLabel;
    fseChillerLoss: TFloatSpinEdit;
    lChillerLossUnit: TLabel;
    lTopUpWater: TLabel;
    fseTopUpWater: TFloatSpinEdit;
    lTopUpWater1: TLabel;
    lTopUpWaterUnit: TLabel;
    eMashWater: TEdit;
    ...
    eBoilVolumeSP: TEdit;
    lPlannedBoil2: TLabel;
    eBoilSGEP: TEdit;
    eBoilVolumeEP: TEdit;
    lEfficiencyBoil: TLabel;
    eEfficiencyS: TEdit;
    eEfficiencyE: TEdit;
    eEfficiencyP: TEdit;
    ...
    lStartTimeBrew: TLabel;
    lEndTimeBrew: TLabel;
    tsFermentation: TTabSheet;
    gbYeast: TGroupBox;
    lYeastAddedAs: TLabel;
    ...
    lStartTempPrimaryUnit: TLabel;
    fseMaxTempPrimary: TFloatSpinEdit;
    lMaxTempPrimaryUnit: TLabel;
    fseEndTempPrimary: TFloatSpinEdit;
    lEndTempPrimaryUnit: TLabel;
    fseSGEndPrimary: TFloatSpinEdit;
    lSGEndPrimaryUnit: TLabel;
    fseSecondaryTemp: TFloatSpinEdit;
    lSecondaryTempUnit: TLabel;
    fseTertiaryTemp: TFloatSpinEdit;
    lTertiaryTempUnit: TLabel;
    fseFG: TFloatSpinEdit;
    lFGUnit: TLabel;
    eABV: TEdit;
    lFGpredicted: TLabel;
    eFGpredicted: TEdit;
    lAAEndPrimary: TLabel;
    eAAEndPrimary: TEdit;
    lAA: TLabel;
    eAA: TEdit;
    lRA: TLabel;
    eRA: TEdit;
    lTransferDate: TLabel;
    ...
    lPressureKegsUnit: TLabel;
    lCarbonationTempKegs: TLabel;
    fseCarbonationTempKegs: TFloatSpinEdit;
    lCarbonationTempKegsUnit: TLabel;
    lPrimingSugarKegs: TLabel;
...
{  bhgMeasurements:= TBHGraph.Create(tsMeasExt);
  ...
  begin
    ...
    lMashWaterUnit.Caption:= R.BatchSize.DisplayUnitString;
    lGrainAbsorptionUnit.Caption:= R.BatchSize.DisplayUnitString;
    lSpargeDeadSpaceUnit.Caption:= lGrainAbsorptionUnit.Caption;
    lSpargeWaterUnit.Caption:= lGrainAbsorptionUnit.Caption;
    lBoilSizeUnit.Caption:= lGrainAbsorptionUnit.Caption;
    lEvapUnit.Caption:= lGrainAbsorptionUnit.Caption;
    lAfterBoilUnit.Caption:= lGrainAbsorptionUnit.Caption;
    lChillerLossUnit.Caption:= lGrainAbsorptionUnit.Caption;
    lTopUpWaterUnit.Caption:= lGrainAbsorptionUnit.Caption;
    lAerationTimeUnit.Caption:= R.TimeAeration.DisplayUnitString;
    lAerationFlowRateUnit.Caption:= R.AerationFlowRate.DisplayUnitString;
    lCoolingToUnit.Caption:= R.CoolingTo.DisplayUnitString;
  end;
...

{
 ...
 begin
   ...
   begin
     ...
     //Maischen en water
     SetControl(fseInfuseAmount, lInfuseAmountUnit, FTemporary.BatchSize, false);
     ...
     lInfuseAmountUnit.Caption:= lInfuseAmountUnit.Caption + ' @ ' + s;
     if FTemporary.Mash <> NIL then
     begin
       SetUnitLabel(lTunTempUnit, FTemporary.Mash.TunTemp);
       SetUnitLabel(lMashWaterUnit, FTemporary.Mash.TunTemp);
     end;
     SetUnitLabel(lMashWaterUnit, FTemporary.BatchSize);
     SetUnitLabel(lGrainAbsorptionUnit, FTemporary.BatchSize);
     SetUnitLabel(lSpargeWaterUnit, FTemporary.BatchSize);
     if FTemporary.Equipment <> NIL then
     begin
       SetControl(fseSpargeDeadSpace, lSpargeDeadSpaceUnit, FTemporary.Equipment.LauterDeadSpace, TRUE);
     end;
     SetUnitLabel(lBoilSizeUnit, FTemporary.BatchSize);
     SetUnitLabel(lAfterBoilUnit, FTemporary.BatchSize);

     SetControl(fseEvaporation, lEvapUnit, FTemporary.BatchSize, false);
     SetControl(fseChillerLoss, lChillerLossUnit, FTemporary.BatchSize, false);
     SetControl(fseTopUpWater, lTopUpWaterUnit, FTemporary.BatchSize, false);

     //Brouwdag
     SetFloatSpinEdit(fseMashpH, FTemporary.pHAdjusted, TRUE);
     if FTemporary.Mash <> NIL then
     begin
       SetControl(fseSpargeTemp, lSpargeTempUnit, FTemporary.Mash.SpargeTemp, TRUE);
       ...
       SetControl(fseLastRunningSG, lLastRunningSGUnit, FTemporary.Mash.SGLastRunnings, TRUE);
     end;
     SetControl(fseSGendmash, lSGendmashUnit, FTemporary.SGEndMash, TRUE);
     SetFloatSpinEdit(fseBoilpHS, FTemporary.pHBeforeBoil, TRUE);
     SetFloatSpinEdit(fseBoilpHE, FTemporary.pHAfterBoil, TRUE);
     SetControl(fseBoilSGS, lBoilSG, FTemporary.EstOG, false);
     ...
     SetControl(fseCoolingTo, lCoolingToUnit, FTemporary.CoolingTo, TRUE);
     SetControl(fseVolToFermenter, lVolToFermenterUnit, FTemporary.VolumeFermenter, TRUE);
     if FTemporary.Equipment <> NIL then
       SetControl(fseTopUpWater, lTopUpWaterUnit, FTemporary.Equipment.TopUpWater, TRUE);
     SetControl(fseTimeAeration, lAerationTimeUnit, FTemporary.TimeAeration, TRUE);
     SetControl(fseAerationFlowRate, lAerationFlowRateUnit, FTemporary.AerationFlowRate, TRUE);

     //Vergisting
     if FTemporary.Yeast[0] <> NIL then
     begin
       SetControl(fseAmountYeast, lAmountYeastUnit, FTemporary.Yeast[0].AmountYeast, TRUE);
       SetControl(fseStarterVolume1, lStarterVolumeUnit1, FTemporary.Yeast[0].StarterVolume1, TRUE);

       SetControl(fseStarterVolume2, lStarterVolumeUnit2, FTemporary.Yeast[0].StarterVolume2, TRUE);
       ...
       lStarterVolumeUnit2.Visible:= bl;
       lStarterVolume2.Visible:= bl;

       SetControl(fseStarterVolume3, lStarterVolumeUnit3, FTemporary.Yeast[0].StarterVolume3, TRUE);
       ...
       lStarterVolumeUnit3.Visible:= bl;
       ...
       SetControl(fseTempStarter, lTempStarterUnit, FTemporary.Yeast[0].Temperature, TRUE);
       SetControl(fseStarterTimeAerated, lStarterTimeAeratedUnit, FTemporary.Yeast[0].TimeAerated, TRUE);
     end;
     SetControl(fseStartTempPrimary, lStartTempPrimaryUnit, FTemporary.StartTempPrimary, TRUE);
     SetControl(fseMaxTempPrimary, lMaxTempPrimaryUnit, FTemporary.MaxTempPrimary, TRUE);
     SetControl(fseEndTempPrimary, lEndTempPrimaryUnit, FTemporary.EndTempPrimary, TRUE);
     SetControl(fseSGEndPrimary, lSGEndPrimaryUnit, FTemporary.SGEndPrimary, TRUE);
     SetControl(fseSecondaryTemp, lSecondaryTempUnit, FTemporary.SecondaryTemp, TRUE);
     SetControl(fseTertiaryTemp, lTertiaryTempUnit, FTemporary.TertiaryTemp, TRUE);
     SetControl(fseFG, lFGUnit, FTemporary.FG, TRUE);

     //Afvullen, proeven
     SetControl(fseVolumeBottles, lVolumeBottlesUnit, FTemporary.VolumeBottles, TRUE);
     SetControl(fseCarbonation, lCarbonationUnit, FTemporary.Carbonation, TRUE);
     SetControl(fseAmountPrimingBottles, lAmountPrimingBottlesUnit, FTemporary.AmountPrimingBottles, TRUE);
     SetControl(fseCarbonationTemp, lCarbonationTempUnit, FTemporary.CarbonationTemp, TRUE);
     SetControl(fseVolumeKegs, lVolumeKegsUnit, FTemporary.VolumeKegs, TRUE);
     SetControl(fseCarbonationKegs, lCarbonationKegsUnit, FTemporary.CarbonationKegs, TRUE);
     SetControl(fseAmountPrimingKegs, lAmountPrimingKegsUnit, FTemporary.AmountPrimingKegs, TRUE);
     SetControl(fseCarbonationTempKegs, lCarbonationTempKegsUnit, FTemporary.CarbonationTempKegs, TRUE);
     SetControl(fsePressureKegs, lPressureKegsUnit, FTemporary.PressureKegs, TRUE);
     FUserClicked:= TRUE;
   end;
 end;
...
begin
 ...
 begin
   ...
   begin
     ...
     SetControl(fseAmountYeast, lAmountYeastUnit, Y.AmountYeast, TRUE);
     SetAmountCells;
     lAmountYeastUnit.Caption:= FTemporary.Yeast[0].AmountYeast.DisplayUnitString;
     UpdateIngredientsGrid;
     UpdatePredictions;
     FChanged:= TRUE;
     FUserClicked:= TRUE;
...

{
 ...
 begin
  ...
  lSearchBrews.Caption:= filter1;
  lSearchRecipes.Caption:= filter1;
 ...
 //   ibugu5 = 'Zeer zoet';
    ...
    lGrainTemp.Caption:= malttemp1;
    seGrainTemp.Hint:= malttemphint1;
    lTunTemp.Caption:= tuntemp1;
    seTunTemp.Hint:= tuntemphint1;
    lInfuseAmount.Caption:= mashvolume1;
    ...
    lMashWater.Caption:= mashvolume2;
    eMashWater.Hint:= mashvolumehint2;
    lGrainAbsorption.Caption:= grainabsorption1;
    eGrainAbsorption.Hint:= grainabsorptionhint1;
    lSpargeWater.Caption:= spargevolume1;
    eSpargeWater.Hint:= spargevolumehint1;
    lSpargeDeadSpace.Caption:= filterloss1;
    fseSpargeDeadSpace.Hint:= filterlosshint1;
    lBoilSize.Caption:= preboilvolume1;
    eBoilSize.Hint:= preboilvolumehint1;
    lEvap.Caption:= evaporation1;
    fseEvaporation.Hint:= evaporationhint1;
    lAfterBoil.Caption:= endboilvolume1;
    eAfterBoil.Hint:= endboilvolumehint1;
    lAfterBoil1.Caption:= endboilvolume2;
    eAfterCooling.Hint:= endboilvolumehint2;
    lSpMa.Caption:= spargemash1;
    eSpMa.Hint:= spargemashhint1;
    lChillerLoss.Caption:= kettleloss1;
    fseChillerLoss.Hint:= kettlelosshint1;
    lAfterBoil2.Caption:= volumefermenter1;
    eToFermenter.Hint:= volumefermenterhint1;
    lTopUpWater.Caption:= topupwater1;
    fseTopUpWater.Hint:= topupwaterhint1;
    lTopUpWater1.Caption:= prefermvolume1;
    ...
    lBrewDate.Caption:= brewdate1;
    deBrewDate.Hint:= brewdatehint1;
    lStartTimeBrew.Caption:= starttime1;
    rxteStartTime.Hint:= starttimehint1;
    rxteStartTime.ShowHint:= TRUE;
    lEndTimeBrew.Caption:= endtime1;
    ...
    lSpargeTemp.Caption:= tempsparge1;
    fseSpargeTemp.Hint:= tempspargehint1;
    lSpargepH.Caption:= pHsparge1;
    fseSpargepH.Hint:= pHspargehint1;
    lLastRunningpH.Caption:= pHspargelast1;
    fseLastRunningpH.Hint:= pHspargelasthint1;
    lLastRunningSG.Caption:= sgspargelast1;
    fseLastRunningSG.Hint:= sgspargelasthint1;

    gbCooling.Caption:= gbcooling1;
    lWhirlpoolTime.Caption:= whirlpooltime1;
    seWhirlpoolTime.Hint:= whirlpooltimehint1;
    lCoolingMethod.Caption:= coolertype1;
    cbCoolingMethod.Hint:= coolertypehint1;
    lCoolingTime.Caption:= cooltime1;
    seCoolingTime.Hint:= cooltimehint1;
    lCoolingTo.Caption:= coolto1;
    fseCoolingTo.Hint:= cooltohint1;
    lVolToFermenter.Caption:= volumetofermenter1;
    fseVolToFermenter.Hint:= volumetofermenterhint1;
    lTopUpWater2.Caption:= topupwater2;
    fseTopUpWater2.Hint:= topupwaterhint2;
    lAerationTime.Caption:= aerationtime1;
    fseTimeAeration.Hint:= aerationtimehint1;
    lAerationFlowRate.Caption:= aerationflowrate1;
    fseAerationFlowRate.Hint:= aerationflowratehint1;
    lAerationType.Caption:= aerationwith1;
    cbAerationType.Hint:= aerationwithhint1;
    lOGFermenter.Caption:= og2;
    eOGFermenter.Hint:= oghint2;
    lIBUFermenter.Caption:= bitterness3;
    eIBUFermenter.Hint:= bitterness3hint3;
    lColorFermenter.Caption:= color3;
    eColorFermenter.Hint:= colorhint3;

    gbVolumes.Caption:= gbvolumes1;
    lCmBelowEdge.Caption:= cmfromtop1;
    lVolume.Caption:= volumecalc1;
    lTunCm.Caption:= mashvol1;
    lLauterCm.Caption:= filtervol1;
    lKettleCm.Caption:= kettlevol1;
